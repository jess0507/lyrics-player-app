...
class AppLocalizationsFr extends AppLocalizations {
  ...
  @override
  String get tab_more => 'Plus';

  @override
  String get profile_account => 'Compte et synchronisation';
  ...
  @override
  String get backup_last_backed_up => 'Dernière sauvegarde';
  ...
  String player_forward(int seconds) {
    return 'Avancer ${seconds}s';
  }

  @override
  String player_rewind(int seconds) {
    return 'Reculer ${seconds}s';
  }
  ...
  @override
  String get player_seek_step => 'Intervalle de saut';
  ...
  String music_import_done(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count morceaux importés',
      one: '1 morceau importé',
    );
    return '$_temp0';
  }
  ...
  String get music_empty_import =>
      'Pas encore de musique. Touchez « Importer de la musique » ou déposez des fichiers audio dans le dossier de cette app via l\'app Fichiers.';
  ...
  String get music_empty =>
      'Aucune musique. Veuillez recharger les chansons de votre appareil.';
  ...
  @override
  String get playlist_recently_played => 'Historique';

  @override
  String get playlist_local_music => 'Musique locale';
  ...
  @override
  String get playlist_search_hint => 'Que voulez-vous écouter ?';

  @override
  String get playlist_search_no_result => 'Aucune chanson correspondante';
