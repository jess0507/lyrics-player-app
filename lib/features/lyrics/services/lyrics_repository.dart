...
class LyricsRepository {
  LyricsRepository(this._isar, this._backupState);
  ...
  /// 同步讀取全部歌詞(GoogleDriveBackupService 上傳快照用)。
